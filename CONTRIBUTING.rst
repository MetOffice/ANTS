...
associated issue on `ANTS issues @ trac
<https://code.metoffice.gov.uk/trac/ancil/newticket>`_ as well.
...
branch of `ancil/ants
<https://code.metoffice.gov.uk/trac/ancil/browser/ants>`_, or with the `trunk`
branch of `ancil/contrib
<https://code.metoffice.gov.uk/trac/ancil/browser/contrib>`_.

New contributors to ANTS (*either or both of the ants and contrib
repositories*) should complete the :ref:`Contributor Licence Agreement (CLA)
<CLA>`, convert the completed form to PDF format, and send it to
...
change please get in contact, describing the use case in detail.
